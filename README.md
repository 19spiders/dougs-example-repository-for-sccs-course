...
This repo is for training purposes for the ATBC Webinar *Reproducible Practices for Ecologists*
The *.gitignore* is to tell R to ignore copying any folders to github, those would be data folders and large datasets that github is not for storage of. Github is for small files of code only, not outputs or figures. 
Dont forget to save! 
Then sync changes from R (local) to Github (remote):
